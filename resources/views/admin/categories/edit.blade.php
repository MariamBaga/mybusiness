...
<nav aria-label="breadcrumb" class="mt-3">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">
            <i class="fas fa-edit"></i> Modifier "{{ Str::limit($category->name, 20) }}"
        </li>
    </ol>
</nav>
@stop
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            ...
                            <span class="float-right" id="nameCounter">{{ strlen(old('name', $category->name)) }}/50</span>
                        </small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="color"
                                   ...
                                   value="{{ old('color', $category->color ?? '#6f42c1') }}"
                        ...
                        <small class="form-text text-muted">
                            Aperçu : <span class="badge" style="background-color: {{ old('color', $category->color ?? '#6f42c1') }}; color: white;">Exemple</span>
                        </small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            ...
                            <span class="float-right" id="descriptionCounter">{{ strlen(old('description', $category->description ?? '')) }}/200</span>
                        </small>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="alert alert-warning">
                                ...
                                <p class="mb-0">
                                    La modification du nom d'une catégorie affectera tous les articles et produits qui y sont associés.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    function resetForm() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('#name').val("{{ old('name', $category->name) }}");
                $('#color').val("{{ old('color', $category->color ?? '#6f42c1') }}");
                $('#description').val("{{ old('description', $category->description) }}");
